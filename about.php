...
<body>
    <div class="container-fluid bg-container8">
        <div class="row">
            <div class="col-12">
                <div class="d-md-none">
                    <div class="header-container1 d-flex flex-row justify-content-between text-white mt-2">
                        <!-- <div>
                            <p><i class="fa-solid fa-phone"></i>  +91 9442833903 & +91 8248935180 </p>
                        </div> -->
                        <div>
    ...
    <div class="dropdown-menu" aria-labelledby="servicesDropdown">
        ...
        <a class="dropdown-item" href="#">AC Tempo on Hire</a>
            ...
            <div class="col-12 text-center mt-5 pb-5 pt-3 head-todo">
                <div>
                    <p class="text-white"><span>Home</span> . About us</p>
                </div>
                <div>
    ...
    <div class="container pt-5 pb-5">
        <div class="row">
            <div class="col-12 col-md-6 mb-4 abt-header">
                <h2>.</h2>
