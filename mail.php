...
try {
    ...
    $mail->Password = 'wimw wgdr mgkr fzqh';
    $mail->SMTPSecure = 'tls';
    $mail->Port = 587;

    $mail->setFrom('srvkmrmarimuthu@gmail.com', 'Garuda:');
    ...
    <table width='100%' align='center' border='0' cellpadding='0' cellspacing='0' style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; width: 100%;' class='background'>
                    ...
                    <tr>
                        <td align='center' valign='top' style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
                            ...
                            font-family: sans-serif;' class='paragraph'>
                                Thanks for registering with Strata 2K25.
                        </td>
                    </tr>
                    <tr>
                     <td align='center' valign='top' style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
                            ...
                            color: #000000;
                            font-family: sans-serif;' class='paragraph'>
                                STRATA’25, The Inter-Collegiate competition being conducted by the department of computer science every year is a technical platform wherein the tech savvy students showcase their presentation, quizzy and programming talents.
                        </td>
                    </tr>
                    <tr>
        ...
        <p><b>Convener:</b> Dr.A.Dharmarajan M.Sc.,M.Phil.,M.Tech.,Ph.D. - 9751624123</p>
        <p><b>Co-ordinator:</b>Mr.M.Sakthisaravanan M.Sc.,M.Phil., - 9787970633</p>
        <p><b>Co-ordinator:</b> Mrs.R.Ananthavalli MCA.,NET., -7708971956 </p>
    ...
    echo "<script>alert('Message has not been sent');window.location.href='./contact.php';</script>";
}
    ?>