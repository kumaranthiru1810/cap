    ...
    <div class="dropdown-menu" aria-labelledby="servicesDropdown">
        ...
        <a class="dropdown-item" href="#">AC Tempo on Hire</a>
            ...
            <div class="col-12 text-center mt-5 pb-5 head-todo">
                <div>
                    <p class="text-white"><span>Home</span> . Gallery</p>
                </div>
                <div>
    ...
    <div class="container mt-5 pb-5 pt-5">
        ...
        <div class="row">
            <div class="d-md-flex flex-row">
                <div class="col-12 col-md-4 mt-3">
                    <div class="gallery-container">
                        <img src="./img/gallery/gallery4.png" class="img-fluid" />
                    </div>
                </div>
                <div class="col-12 col-md-4 mt-3">
                    <div class="gallery-container">
                        <img src="./img/gallery/gallery5.png" class="img-fluid"/>
                    </div>
                </div>
                <div class="col-12 col-md-4 mt-3">
                    <div class="gallery-container">
                        <img src="./img/gallery/gallery6.png" class="img-fluid" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="d-md-flex flex-row">
            <div class="col-12 col-sm-12 col-md-4 mt-3">
                <div class="gallery-container">
                    <img src="./img/gallery/gallery7.png" class="img-fluid" />
                </div>
            </div>
            <div class="col-12 col-md-4 mt-3">
                <div class="gallery-container">
                    <img src="./img/gallery/gallery8.png" class="img-fluid" />
                </div>
            </div>
            <div class="col-12 col-md-4 mt-3">
                <div class="gallery-container">
