...
<body>
    ...
    <div class="dropdown-menu" aria-labelledby="servicesDropdown">
        ...
        <a class="dropdown-item" href="#">AC Tempo on Hire</a>
            ...
            <div class="col-12 text-center mt-5 pb-5 head-todo">
                <div>
                    <p class="text-white"><span>Home</span> . Contact Us</p>
                </div>
                <div>
    ...
    <div class="container pt-5 pb-5">
        <div class="row">
            <div class="col-12 text-center mb-5 abt-header">
                <h2>.</h2>
                <p>Contact Now</p>
                <h1>Get in Touch</h1>
            </div>
            ...
            <div class="col-12 col-md-4 contact-container mb-4">
                <div class="text-center">
                    ...
                    <h2>Location</h2>
                    <p>9XPF + 3G4 EB Colony,<br>TamilNadu.</p>
                </div>
            </div>
            <div class="col-12 col-md-4 contact-container mb-4">
                <div class="text-center">
            ...
            <div class="bg-white d-md-flex flex-row shadow-lg p-md-5 mt-4 mb-5 rounded-lg py-5">
                <div class="col-12 col-md-6 d-none d-md-block mt-5">
                    <img src="./img/contactimg.png" class="contact-img img-fluid" width="470px" height="470px" alt="Contact Us Image" />
                </div>
